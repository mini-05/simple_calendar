...
9. **[중요] 히스토리(Changelog) 보존 및 상세 기록 원칙:** AI는 토큰을 절약한다는 핑계로 `memory.md`의 '3. 버전별 상세 변천사' 항목을 절대 임의로 축약, 요약, 또는 과거 내역을 삭제해선 안 된다. 아무리 텍스트가 길어져도 기존의 세세한 포맷을 100% 무조건 유지하며 새 버전을 누적해야 한다. *(개발자 특별 지시사항)*
