            ...
            child: ListView(
              ...
              children: [
                ...
                _switchTile(
                  icon: Icons.security,
                  label: '화면 캡처 방지',
                  subtitle: '앱 화면의 캡처 및 녹화를 차단합니다',
                  value: _s.preventCapture,
                  onChanged: (v) => _update(_s.copyWith(preventCapture: v)),
                ),
                        ...
                        Row(
                          children:
                              [
                                ...
                                final isLast =
                                    mode == CalendarNavMode.swipeHorizontal;
                                return Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      _update(
                                        _s.copyWith(calendarNavMode: mode),
                                      );
                                    },
                                    child: Container(
